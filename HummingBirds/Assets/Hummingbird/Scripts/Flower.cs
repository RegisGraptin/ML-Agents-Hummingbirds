...
public class Flower : MonoBehaviour
{
    ...
    /// <summary>
    /// A vector pointing straight out of the flower. Define the orientation of the flower.
    /// </summary>
    ...
    {
        // Nectar successfully taken by the bird
        ...
        if (NectarAmount <= 0) 
        {
            ...
            // Note :: Helps ML agent to not be stuck after collecting the nectar
            flowerCollider.gameObject.SetActive(false);
            nectarCollider.gameObject.SetActive(false);

            // Change the flower color to indicate that the flower is empty
